...
#
# Created: Wed Apr 16 17:41:05 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.rb_method_diff = QtGui.QRadioButton(self.groupBox_2)
        self.rb_method_diff.setGeometry(QtCore.QRect(10, 60, 82, 17))
        self.rb_method_diff.setObjectName(_fromUtf8("rb_method_diff"))
        ...
        self.diff_tab = QtGui.QWidget()
        self.diff_tab.setObjectName(_fromUtf8("diff_tab"))
        self.groupBox_5 = QtGui.QGroupBox(self.diff_tab)
        self.groupBox_5.setGeometry(QtCore.QRect(10, 10, 681, 271))
        self.groupBox_5.setObjectName(_fromUtf8("groupBox_5"))
        self.table_summary_diff = QtGui.QTableWidget(self.groupBox_5)
        self.table_summary_diff.setGeometry(QtCore.QRect(10, 20, 611, 141))
        self.table_summary_diff.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.table_summary_diff.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.table_summary_diff.setAlternatingRowColors(True)
        self.table_summary_diff.setSelectionMode(QtGui.QAbstractItemView.NoSelection)
        self.table_summary_diff.setSelectionBehavior(QtGui.QAbstractItemView.SelectRows)
        self.table_summary_diff.setShowGrid(True)
        self.table_summary_diff.setColumnCount(2)
        self.table_summary_diff.setObjectName(_fromUtf8("table_summary_diff"))
        self.table_summary_diff.setRowCount(3)
        item = QtGui.QTableWidgetItem()
        self.table_summary_diff.setVerticalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        self.table_summary_diff.setVerticalHeaderItem(1, item)
        item = QtGui.QTableWidgetItem()
        self.table_summary_diff.setVerticalHeaderItem(2, item)
        item = QtGui.QTableWidgetItem()
        self.table_summary_diff.setHorizontalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        self.table_summary_diff.setHorizontalHeaderItem(1, item)
        item = QtGui.QTableWidgetItem()
        self.table_summary_diff.setItem(0, 0, item)
        item = QtGui.QTableWidgetItem()
        self.table_summary_diff.setItem(0, 1, item)
        item = QtGui.QTableWidgetItem()
        self.table_summary_diff.setItem(1, 0, item)
        item = QtGui.QTableWidgetItem()
        self.table_summary_diff.setItem(1, 1, item)
        item = QtGui.QTableWidgetItem()
        self.table_summary_diff.setItem(2, 0, item)
        item = QtGui.QTableWidgetItem()
        self.table_summary_diff.setItem(2, 1, item)
        self.table_summary_diff.verticalHeader().setDefaultSectionSize(28)
        self.tabWidget.addTab(self.diff_tab, _fromUtf8(""))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rb_method_diff.setText(_translate("MainWindow", "Difference", None))
        ...
        self.groupBox_5.setTitle(_translate("MainWindow", "Deduplication Summary", None))
        item = self.table_summary_diff.verticalHeaderItem(0)
        item.setText(_translate("MainWindow", "Original Records", None))
        item = self.table_summary_diff.verticalHeaderItem(1)
        item.setText(_translate("MainWindow", "Difference (unique titles in file 2)", None))
        item = self.table_summary_diff.verticalHeaderItem(2)
        item.setText(_translate("MainWindow", "Duplicate Titles", None))
        item = self.table_summary_diff.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Total", None))
        item = self.table_summary_diff.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "File", None))
        __sortingEnabled = self.table_summary_diff.isSortingEnabled()
        self.table_summary_diff.setSortingEnabled(False)
        item = self.table_summary_diff.item(0, 0)
        item.setText(_translate("MainWindow", "0", None))
        item = self.table_summary_diff.item(0, 1)
        item.setText(_translate("MainWindow", "\"\"", None))
        item = self.table_summary_diff.item(1, 0)
        item.setText(_translate("MainWindow", "0", None))
        item = self.table_summary_diff.item(1, 1)
        item.setText(_translate("MainWindow", "\"\"", None))
        item = self.table_summary_diff.item(2, 0)
        item.setText(_translate("MainWindow", "0", None))
        item = self.table_summary_diff.item(2, 1)
        item.setText(_translate("MainWindow", "\"\"", None))
        self.table_summary_diff.setSortingEnabled(__sortingEnabled)
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.diff_tab), _translate("MainWindow", "Results Difference", None))
